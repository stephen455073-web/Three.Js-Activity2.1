...
gui.add(spotLight, 'intensity').min(0).max(1).step(0.001).name('Spot Intensity')
gui.add(rectAreaLight, 'intensity').min(0).max(5).step(0.001).name('RectArea Intensity')
...
const tick = () => {
  ...
  // Update spot helper (needs refresh)
